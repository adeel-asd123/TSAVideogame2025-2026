...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/home/rdb/local/src/emsdk/upstream/emscripten/emar',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': '/home/rdb/local/src/emsdk/upstream/emscripten/emcc',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '.js',
 'BUILDPYTHON': 'python.js',
 'BUILD_GNU_TYPE': 'aarch64-redhat-linux-gnu',
 'BUILD_SCRIPTS_DIR': 'build/scripts-3.12',
 'BYTESTR_DEPS': '\\',
 'CC': '/home/rdb/local/src/emsdk/upstream/emscripten/emcc',
 'CCSHARED': '-fPIC',
 ...
 'CONFIGURE_LDFLAGS_NODIST': '-sALLOW_MEMORY_GROWTH -sTOTAL_MEMORY=20971520 '
                             '-sWASM_BIGINT -sFORCE_FILESYSTEM -lidbfs.js '
 ...
 'CONFIG_ARGS': "'-C' '--host=wasm32-unknown-emscripten' "
                ...
                "'--with-build-python=/home/rdb/local/src/cpython/builddir/build/python' "
                "'CONFIG_SITE=/home/rdb/local/src/cpython/Tools/wasm/config.site-wasm32-emscripten' "
                "'build_alias=aarch64-redhat-linux-gnu' "
                "'host_alias=wasm32-unknown-emscripten' 'PKG_CONFIG_PATH=' "
                "'PKG_CONFIG_LIBDIR=/home/rdb/local/src/emsdk/upstream/emscripten/cache/sysroot/local/lib/pkgconfig:/home/rdb/local/src/emsdk/upstream/emscripten/cache/sysroot/lib/pkgconfig' "
                "'CC=/home/rdb/local/src/emsdk/upstream/emscripten/emcc'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/rdb/local/src/cpython/builddir/emscripten-browser/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/rdb/local/src/cpython/builddir/emscripten-browser/lcov-report',
 ...
 'CXX': '/home/rdb/local/src/emsdk/upstream/emscripten/em++',
 ...
 'EXE': '.js',
 'EXEMODE': 755,
 'EXENAME': '/usr/local/bin/python3.12.js',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-312-wasm32-emscripten.so',
 'FILEMODE': 644,
 'FLOAT_WORDS_BIGENDIAN': 0,
 'FREEZE_MODULE': '/home/rdb/local/src/cpython/builddir/build/python '
                  '../../Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/home/rdb/local/src/cpython/builddir/build/python '
                            '../../Programs/_freeze_module.py',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/home/rdb/local/src/emsdk/upstream/emscripten/emcc',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.12.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/home/rdb/local/src/emsdk/upstream/emscripten/emcc',
 'LDVERSION': '3.12',
 'LIBC': '',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBHACL_CFLAGS': '-I../../Modules/_hacl/include -D_BSD_SOURCE '
 ...
 'LIBPL': '/usr/local/lib/python3.12/config-3.12-wasm32-emscripten',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.12.a',
 'LIBRARY_DEPS': 'libpython3.12.a  ./usr/local/lib/python3.12/os.py '
                 'python.html python.worker.js',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-ldl  -lpthread',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/home/rdb/local/src/emsdk/upstream/emscripten/emcc',
 'LINKFORSHARED': '-sMAIN_MODULE --preload-file=./usr/local -O2 -g0',
 'LINK_PYTHON_DEPS': 'libpython3.12.a  ./usr/local/lib/python3.12/os.py '
                     'python.html python.worker.js',
 'LINK_PYTHON_OBJS': '\\',
 'LIPO_32BIT_FLAGS': '',
 'LIPO_INTEL64_FLAGS': '',
 ...
 'LOCALMODLIBS': '-lm -lm -lm -lm -lm -lm Modules/_decimal/libmpdec/libmpdec.a '
                 '-sUSE_ZLIB -sUSE_BZIP2 -sUSE_ZLIB    '
                 'Modules/_hacl/libHacl_Hash_SHA2.a   -lm '
                 'Modules/expat/libexpat.a              -sUSE_SQLITE3',
 'MACHDEP': 'emscripten',
 'MACHDEP_OBJS': '',
 ...
 'MODBUILT_NAMES': 'array  _asyncio  _bisect  _contextvars  _csv  _heapq  '
                   ...
                   '_datetime  _decimal  binascii  _bz2  zlib  _md5  _sha1  '
                   '_sha2  _sha3  _blake2  pyexpat  _elementtree  _codecs_cn  '
                   '_codecs_hk  _codecs_iso2022  _codecs_jp  _codecs_kr  '
                   '_codecs_tw  _multibytecodec  unicodedata  _crypt  mmap  '
                   'select  _socket  _sqlite3  xxlimited  xxlimited_35  '
 ...
 'MODOBJS': 'Modules/arraymodule.o  Modules/_asynciomodule.o  '
            ...
            'Modules/_bz2module.o  Modules/zlibmodule.o  Modules/md5module.o '
            ...
            'Modules/_blake2/blake2s_impl.o  Modules/pyexpat.o  '
            'Modules/_elementtree.o  Modules/cjkcodecs/_codecs_cn.o  '
            ...
            'Modules/_cryptmodule.o  Modules/mmapmodule.o  '
            ...
            'Modules/_sqlite/util.o  Modules/atexitmodule.o  '
 ...
 'MODSHARED_NAMES': 'xxlimited xxlimited_35',
 ...
 'MODULE__MD5_CFLAGS': '-I../../Modules/_hacl/include '
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/rdb/local/src/cpython/builddir/emscripten-browser '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/home/rdb/local/src/cpython/builddir/emscripten-browser/`cat '
                     'pybuilddir.txt`:)../../Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__emscripten_wasm32-emscripten '
                     '/home/rdb/local/src/cpython/builddir/build/python',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/home/rdb/local/src/cpython/builddir/build/python',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code '
                   ...
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-sALLOW_MEMORY_GROWTH -sTOTAL_MEMORY=20971520 '
                    '-sWASM_BIGINT -sFORCE_FILESYSTEM -lidbfs.js -lnodefs.js '
 ...
 'SETPGRP_HAVE_ARG': 0,
 'SHAREDMODS': 'Modules/xxlimited.cpython-312-wasm32-emscripten.so '
               'Modules/xxlimited_35.cpython-312-wasm32-emscripten.so',
 'SHELL': '/bin/sh -e',
 'SHLIBS': '-ldl  -lpthread',
 'SHLIB_SUFFIX': '.so',
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-312-wasm32-emscripten',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/home/rdb/local/src/cpython/builddir/emscripten-browser '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/home/rdb/local/src/cpython/builddir/emscripten-browser/`cat '
               'pybuilddir.txt`:)../../Lib '
               ...
               '/home/rdb/local/src/cpython/builddir/build/python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/home/rdb/local/src/cpython/builddir/emscripten-browser '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/home/rdb/local/src/cpython/builddir/emscripten-browser/`cat '
               'pybuilddir.txt`:)../../Lib '
 ...
 'abs_builddir': '/home/rdb/local/src/cpython/builddir/emscripten-browser',
 'abs_srcdir': '/home/rdb/local/src/cpython/builddir/emscripten-browser/../..',
